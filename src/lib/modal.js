            ...
            <div className="flex gap-x-2">
                ...
                <div className="w-[40%] h-[35vh] flex flex-col bg-slate-500 rounded-2xl p-2 gap-y-2">
                    ...
                    <div className="flex flex-col gap-y-2">
                        <p><img className="w-[18px] h-[21px]" src={location} alt="" /></p>
                        <p><img className="w-[18px] h-[19px]" src={dollar} alt="" /></p>
                        <p><img className="w-[18px] h-[19px]" src={clock} alt="" /></p>
                        <p><img className="w-[18px] h-[19px]" src={world} alt="" /></p>
                        <p><img className="w-[18px] h-[19px]" src={user} alt="" /></p>
                        <p><img className="w-[18px] h-[19px]" src={car} alt="" /></p>
                    </div>
                </div>
            </div>
            {/* modal des */}
