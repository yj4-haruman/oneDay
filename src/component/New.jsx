          ...
          <div className='w-full sm:w-[345px] h-full shadow-lg bg-white flex flex-col gap-y-[12px] rounded-2xl mb-3'>
            ...
            <div className='w-full flex justify-between px-2 items-center'>
              ...
              <div  className='flex gap-x-5'>
                <div className=' flex gap-x-1 items-center'><img className='w-[16px] h-[18px]' src={world} alt="World" />온라인</div>
                <div className='flex gap-x-1 items-center'><img className='w-[18px] h-[16px]' src={user} alt="" />5 ~ 10명</div>
              </div>
            </div>
            {/* class name */}
            ...
            <div className='flex justify-between px-2'>
              <div className='flex gap-x-2 items-center'><img src={star} alt="" />찜하기</div>
              <div>100,000원</div>
            </div>
          </div>
