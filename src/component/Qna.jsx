  ...
  return (
    <div className="w-full flex justify-center py-5 select-none">
      <div className="w-[70%] max-w-[1200px] h-full flex flex-col gap-y-2">
        ...
        <div className="flex flex-col border border-[#ccc] rounded-2xl overflow-hidden">
          ...
          <Detail summ="온라인 클래스는 어떻게 진행되나요?" txt="Zoom, Skype 등 화상회의 프로그램을 사용합니다. 재료가 필요한 클래스는 집으로 재료를 배송해드려요." border="border-b" />
